...
export function Safety() {
  const { cap, haltReason, paused, strategyState } = useVaultDashboard();
    ...
    <>
      ...
      <section className="safety-grid">
        ...
        <div className="glass safety-card">
          ...
          <p>EpochTick subscription support is available in the system design, but active subscription status is not confirmed here.</p>
        </div>
        <div className="glass safety-card">
          <span className="step">04</span>
          <Icon name="arrow" size={25} />
          <h3>Fair withdrawal queue</h3>
          <p>When instant liquidity is unavailable, shares enter a FIFO queue whose claims take priority over later instant exits.</p>
        </div>
      </section>
      ...
      <section className="risk-disclosure">
        ...
        <div className="risk-list">
          ...
          <div><strong>Market & liquidity risk</strong><p>Maker strategies can lose value, and redemptions may be delayed through the withdrawal queue.</p></div>
